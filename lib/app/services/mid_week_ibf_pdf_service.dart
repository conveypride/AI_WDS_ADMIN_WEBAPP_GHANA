// lib/app/services/mid_week_ibf_pdf_service.dart
...
class MidWeekIbfPdfService {
  ...
  static pw.Widget _buildTitle() {
    return pw.Center(
      child: pw.Text(
        'IMPACT-BASED FORECAST FOR GHANA (MIDWEEK)',
        style: pw.TextStyle(
          fontSize: 14,
          fontWeight: pw.FontWeight.bold,
