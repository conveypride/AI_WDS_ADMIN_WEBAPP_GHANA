                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        title: Text("Mid-Week Forecast (Issue: $issueTime UTC)", style: TextStyle(fontWeight: FontWeight.w700, color: wc.textPrimary, fontSize: 14)),
                        subtitle: Padding(
...
class _InputTab extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text("Draw Mid-Week Impact Areas", style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w800, color: wc.textPrimary)),
          ...
          const SizedBox(height: 32),
          Text(" Mid-Week Impact-Based Forecast Details", style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w800, color: wc.textPrimary)),
          const SizedBox(height: 16),
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            const SizedBox(width: 12),
                            const Text("PUBLISH MID-WEEK IBF", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 14, letterSpacing: 0.5)),
                          ],
                        ),
                      ),
                    ),
  ...
  Widget _structuredInputCell(MidWeekIBFController ctrl, String sector, int dayIndex, BuildContext context) {
    final wc = context.wColors;
