...
class MidWeekMapWidget extends StatelessWidget {
  ...
  Widget _buildItemVisual(MidWeekMapItem item) {
    if (item.type == MidWeekItemType.text) return Text(item.value, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900, color: Colors.black, shadows: const [Shadow(color: Colors.white, blurRadius: 4), Shadow(color: Colors.black54, offset: Offset(1, 1), blurRadius: 2)]));
    IconData iconData;
    switch (item.value) {
