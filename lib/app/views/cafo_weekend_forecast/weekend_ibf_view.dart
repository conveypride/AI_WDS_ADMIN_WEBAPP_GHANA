                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        title: Text("Weekend Forecast (Issue: $issueTime UTC)", style: TextStyle(fontWeight: FontWeight.w700, color: wc.textPrimary, fontSize: 14)),
                        subtitle: Padding(
...
class _InputTab extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text("Draw Weekend Impact Areas", style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w800, color: wc.textPrimary)),
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: Obx(() {
                ...
                return Row(
                  children: [
                    Expanded(child: WeekendMapWidget(ctrl: ctrl, period: 'day1', dateLabel: "DAY 1: ${DateFormat('E, d MMM').format(dates[0])}", isDark: isDark)),
                    Container(width: 1, color: wc.border),
                    Expanded(child: WeekendMapWidget(ctrl: ctrl, period: 'day2', dateLabel: "DAY 2: ${DateFormat('E, d MMM').format(dates[1])}", isDark: isDark)),
                    Container(width: 1, color: wc.border),
                    Expanded(child: WeekendMapWidget(ctrl: ctrl, period: 'day3', dateLabel: "DAY 3: ${DateFormat('E, d MMM').format(dates[2])}", isDark: isDark)),
                  ],
                );
              }),
            ),
          ...
          const SizedBox(height: 32),
          Text("Weekend Impact-Based Forecast Details", style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w800, color: wc.textPrimary)),
          const SizedBox(height: 16),
                  ...
                  children: [
                    TableRow(
                      ...
                      children: [
                        ...
                        _headerCell("DAY 1\n${DateFormat('E, dd MMM').format(dates[0])}", context), 
                        _headerCell("DAY 2\n${DateFormat('E, dd MMM').format(dates[1])}", context),
                        _headerCell("DAY 3\n${DateFormat('E, dd MMM').format(dates[2])}", context), 
                      ],
                    ),
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            const SizedBox(width: 12),
                            const Text("PUBLISH WEEKEND IBF", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 14, letterSpacing: 0.5)),
                          ],
                        ),
                      ),
                    ),
  ...
  Widget _structuredInputCell(WeekendIBFController ctrl, String sector, int dayIndex, BuildContext context) {
    final wc = context.wColors;
