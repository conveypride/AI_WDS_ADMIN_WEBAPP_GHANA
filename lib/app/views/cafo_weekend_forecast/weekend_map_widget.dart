...
class WeekendMapWidget extends StatelessWidget {
          ...
          child: Row(
            ...
            children: [
              PopupMenuButton<String>(
                ...
                onSelected: (iconName) => _spawnItem(WeekendItemType.icon, iconName, mapController),
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (letter) => _spawnItem(WeekendItemType.text, letter, mapController),
                color: isDark ? Colors.grey.shade800 : Colors.white,
  ...
  void _spawnItem(WeekendItemType type, String value, MapController mapCtrl) => ctrl.addMapItem(period, type, value, mapCtrl.camera.center);
  ...
  Widget _buildItemVisual(WeekendMapItem item) {
    if (item.type == WeekendItemType.text) return Text(item.value, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900, color: Colors.black, shadows: const [Shadow(color: Colors.white, blurRadius: 4), Shadow(color: Colors.black54, offset: Offset(1, 1), blurRadius: 2)]));
    IconData iconData;
    switch (item.value) {
