...
class WeeklyMapWidget extends StatelessWidget {
  final WeeklyIBFController ctrl;
  final String period;
  final String dateLabel;
  final bool isDark;

  const WeeklyMapWidget({
    super.key, 
    required this.ctrl, 
  ...
  void _spawnItem(WeeklyItemType type, String value, MapController mapCtrl) => ctrl.addMapItem(period, type, value, mapCtrl.camera.center);
  ...
  Widget _buildItemVisual(WeeklyMapItem item) {
