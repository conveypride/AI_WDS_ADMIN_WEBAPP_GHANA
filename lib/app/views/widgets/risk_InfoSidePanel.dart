        ...
        children: [
          ...
          Padding(
            ...
            child: Obx(() {
             ...
             return   Column(
                children: [ 
                   // NEW: Weather Forecast Risk Matrix
              ...
              Column(
                children: [
                  _DetailRow(label: 'Date', value: f.date, isDark: isDark),
                  _DetailRow(label: 'Time Issued', value: f.timeIssued, isDark: isDark),
                  _DetailRow(label: 'Valid From', value: f.validFrom, isDark: isDark),
